...
def select_model(args, device):
    ...
    if model_id == 0:
        ...
        # Team 03 ProCata
        from models.team03_ProCata import io as ProCata
        name = f"{model_id:02}_ProCata"
        model_path = os.path.join('model_zoo', 'team03_ProCata', 'ProCata.pth')
        model_func = ProCata.main
    else:
